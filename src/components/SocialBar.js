...
const icons = [
  ...
  {name:'youtube', svg: `<svg xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" viewBox="0 0 100 100">
  <path fill="currentColor" d="M87.4998 50v-3.043c0-6.4765-.7508-12.9488-.7508-12.9488s-.7324-5.5165-2.9807-7.9457c-2.8531-3.1832-6.049-3.2031-7.5144-3.3826-10.495-.8141-26.2375-.8141-26.2375-.8141h-.0352s-15.7425 0-26.2368.8141c-1.4654.1795-4.6581.1994-7.5145 3.3826-2.2462 2.4292-2.9799 7.9457-2.9799 7.9457s-.7497 6.4723-.7497 12.9467v6.0902c0 6.4744.7497 12.9467.7497 12.9467s.7337 5.5165 2.9799 7.9457c2.8564 3.1832 6.0491 3.2031 7.5145 3.3826 10.4943.8141 26.2368.8141 26.2368.8141h.0352s15.7425 0 26.2375-.8141c1.4654-.1795 4.6613-.1994 7.5144-3.3826 2.2483-2.4292 2.9807-7.9457 2.9807-7.9457s.7508-6.4723.7508-12.9488V50zM40.6339 34.3751v31.2498L65.6251 50 40.6339 34.3751zm43.0056-.0358c-.2536-1.7189-1.0787-4.9617-2.1815-6.1725-1.7015-1.8681-3.1608-2.142-5.515-2.3774-8.6009-.8599-17.2936-.7986-25.9266-.7986h-.0352c-8.6328 0-17.3252-.0613-25.9259.7986-2.3555.2355-3.8124.5082-5.5152 2.3775-1.1165 1.2257-1.9484 4.5382-2.1901 6.238-.4718 4.0952-.7247 8.4381-.7247 12.55v6.0902c0 4.1101.2522 8.4562.7246 12.5497.2417 1.6996 1.0737 5.0125 2.1902 6.2383 1.7028 1.8693 3.1597 2.142 5.5152 2.3775 8.6007.8599 17.2931.7986 25.9259.7986h.0352c8.633 0 17.3257.0613 25.9266-.7986 2.3542-.2354 3.8135-.5093 5.515-2.3774 1.1171-1.2265 1.9492-4.5378 2.1911-6.2384.4725-4.0955.7257-8.4395.7257-12.5518v-6.086c0-2.8856-.1437-5.7853-.3661-8.6622-.1017-1.3149-.2754-2.6495-.3692-3.9555z"/>
  </svg>`},
    ...
    render={data => (
      <div className={social.wrap}>
        {icons.map(i => {
          ...
          return (
            <a key={`icon_${i.name}`} aria-label={'go to '+i.name} rel="noopener noreferrer" target="_blank" href={checkIcon[i.name + '_link']} className={social.icon} style={{ height: i.name !== 'youtube' ? 20: 22, width: i.name !== 'youtube' ? 20: 26 }}>
